...
export const products = [
  ...
  },
  {
    name: "Праскови",
    icon: "🍑",
    description: "Сочни сезонни праскови с летен аромат.",
    status: "soon" as ProductStatus,
    image: null,
  },
] as const;
...
export const repairServices = [
  { icon: "⌂", title: "Вътрешни ремонти", description: "Освежаване и цялостни подобрения на помещения." },
  { icon: "▱", title: "Външни ремонти", description: "Работа по фасади, огради и външни части на дома." },
  { icon: "✦", title: "Шпакловка и боядисване", description: "Подготовка на стените и чисто завършване на повърхностите." },
  { icon: "▦", title: "Зидария", description: "Изграждане и поправка на стени и малки конструкции." },
  { icon: "◇", title: "Плочки и настилки", description: "Полагане на плочки за бани, кухни, тераси и дворове." },
  { icon: "◫", title: "Ремонти на бани", description: "Подготовка, облицовка и довършителни дейности." },
  { icon: "⌑", title: "Външни бани и тоалетни", description: "Практични решения за дворни и стопански пространства." },
  { icon: "⌂", title: "Дворни постройки", description: "Малки постройки, навеси и подобрения около дома." },
  { icon: "+", title: "Други ремонтни дейности", description: "Обадете се, за да обсъдите конкретната работа." },
] as const;

export const repairSteps = [
  { number: "01", title: "Кратък разговор", description: "Разказвате какво трябва да се направи и къде се намира обектът." },
  { number: "02", title: "Оглед и уговорка", description: "При нужда Рангел вижда мястото и уточнявате възможностите." },
  { number: "03", title: "Работа по обекта", description: "Съгласуваната работа се изпълнява според конкретния случай." },
] as const;
